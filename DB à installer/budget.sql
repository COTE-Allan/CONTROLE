...
;
--
-- Base de données : `controle_app_db`
DROP DATABASE IF EXISTS `controle_app_db`;
CREATE DATABASE IF NOT EXISTS `controle_app_db` DEFAULT CHARACTER SET UTF8;
USE `controle_app_db`;
--
-- --------------------------------------------------------
--
...
VALUES (1, '2021-04-16 00:00:00', '500', 'Achat', 1);
-- --------------------------------------------------------
--
...
VALUES (2, '1500', '2021-04-22 00:00:00', 5, 1);
-- --------------------------------------------------------
--
...
--
INSERT INTO `incomes_categories` (`inc_cat_id`, `inc_cat_name`)
VALUES (1, 'Salaire'),
  (2, 'BIC'),
  (3, 'BNC'),
  (4, 'Pension'),
...
VALUES (1, 'John', 'doe', '1992-01-06 00:00:00');
--
...
--
ALTER TABLE `incomes_categories`
MODIFY `inc_cat_id` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 10;
--
