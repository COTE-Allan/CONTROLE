<header id="menu">
    <nav>
        <a class="nav_element" href="dashboard.php" <?php if (basename($_SERVER['PHP_SELF']) == "dashboard.php") {
                                                        echo 'id="active_nav"';
                                                    } ?>>
            <?xml version="1.0" ?><svg style="enable-background:new 0 0 50 50;" version="1.1" viewBox="0 0 50 50" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g id="Layer_1">
                    <path d="M25,49c13.233,0,24-10.767,24-24S38.233,1,25,1S1,11.767,1,25S11.767,49,25,49z M25,47c-5.706,0-10.912-2.185-14.825-5.761   L25.414,26h21.561C46.45,37.668,36.796,47,25,47z M46.975,24H26V3.025C37.337,3.535,46.465,12.663,46.975,24z M24,3.025v21.561   L8.761,39.825C5.185,35.912,3,30.706,3,25C3,13.204,12.332,3.55,24,3.025z" />
                </g>
                <g />
            </svg>
        ...
        <a class="nav_element" href="add_user.php" <?php if (basename($_SERVER['PHP_SELF']) == "add_user.php") {
                                                        echo 'id="active_nav"';
                                                    } ?>>
            <?xml version="1.0" ?><svg style="enable-background:new 0 0 50 50;" version="1.1" viewBox="0 0 50 50" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g id="Layer_1">
                    ...
                    <polygon points="36,33 34,33 34,36 31,36 31,38 34,38 34,41 36,41 36,38 39,38 39,36 36,36  " />
                </g>
                <g />
            </svg>
            <label>Ajouter un User</label>

        </a>

        <a class="nav_element" href="add_recipe.php" <?php if (basename($_SERVER['PHP_SELF']) == "add_recipe.php") {
                                                            echo 'id="active_nav"';
                                                        } ?>>
            <?xml version="1.0" ?><svg style="enable-background:new 0 0 50 50;" version="1.1" viewBox="0 0 50 50" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g id="Layer_1">
                    <polygon points="2.707,48.707 20,31.414 20,41 22,41 22,28 9,28 9,30 18.586,30 1.293,47.293  " />
                    <polygon points="3,38 5,38 5,3 47,3 47,45 12,45 12,47 49,47 49,1 3,1  " />
                </g>
                <g />
            </svg>
            <label>Ajout de recette</label>

        </a>

        <a class="nav_element" href="add_spend.php" <?php if (basename($_SERVER['PHP_SELF']) == "add_spend.php") {
                                                        echo 'id="active_nav"';
                                                    } ?>>
            <?xml version="1.0" ?><svg style="enable-background:new 0 0 50 50;" version="1.1" viewBox="0 0 50 50" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g id="Layer_1">
            ...
            <label>Ajout de dépense</label>

        </a>

        <a class="nav_element" href="list_user.php" <?php if (basename($_SERVER['PHP_SELF']) == "list_user.php") {
                                                        echo 'id="active_nav"';
                                                    } ?>>
            <?xml version="1.0" ?><svg style="enable-background:new 0 0 50 50;" version="1.1" viewBox="0 0 50 50" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g id="Layer_1">
            ...
            <label>Liste des Users</label>

        </a>
        <a class="nav_element" href="list_transaction.php" <?php if (basename($_SERVER['PHP_SELF']) == "list_transaction.php") {
                                                                echo 'id="active_nav"';
                                                            } ?>>
            <?xml version="1.0" ?><svg id="Layer_1" style="enable-background:new 0 0 50 50;" version="1.1" viewBox="0 0 50 50" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g id="Layer_1_1_">
                    <path d="M24,1H1v44h23h2h23V1H26H24z M24,43H3V3h21V43z M47,3v40H26V3H47z" />
                    <rect height="2" width="48" x="1" y="47" />
                    <rect height="2" width="13" x="7" y="7" />
                    <rect height="2" width="13" x="7" y="13" />
                    <rect height="2" width="13" x="7" y="19" />
                    <rect height="2" width="13" x="7" y="25" />
                    <rect height="2" width="13" x="7" y="31" />
                    <rect height="2" width="13" x="7" y="37" />
                    <rect height="2" width="13" x="30" y="7" />
                    <rect height="2" width="13" x="30" y="13" />
                    <rect height="2" width="13" x="30" y="19" />
                    <rect height="2" width="13" x="30" y="25" />
                    <rect height="2" width="13" x="30" y="31" />
                    <rect height="2" width="13" x="30" y="37" />
                </g>
            </svg>
